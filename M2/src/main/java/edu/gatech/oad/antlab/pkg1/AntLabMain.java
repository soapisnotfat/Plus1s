 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Jinghua Zhang");
		  toPrint += p1.toString("jzhang866");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Zijin Luo");
		  toPrint += p2.toString("zluo68");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Zhu Zhuang");
		  toPrint += p3.toString("zzhuang38");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Siyu Li");
          toPrint += p4.toString("sli602");
