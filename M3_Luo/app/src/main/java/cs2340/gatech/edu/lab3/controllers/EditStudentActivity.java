...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        ArrayAdapter<String> adapter_1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item, Student.legalClassStanding);
        adapter_1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        classStandingSpinner.setAdapter(adapter_1);
    ...
    protected void onAddPressed(View view) {
        ...
        _student.setClassStanding((String) classStandingSpinner.getSelectedItem());
